...
import { IconUsers, IconBolt, IconTarget, IconBrandGithub, IconBrandSlack, IconTool } from '@tabler/icons-react';
...
const values = [
  {
    ...
    description: 'Eliminate manual reviewer assignment with intelligent automation that matches PRs to the right reviewers.',
  },
  {
    icon: IconTarget,
    title: 'Smart Routing Rules',
    description: 'Build complex routing logic without code. Route by file patterns, branches, labels, and more.',
  },
  {
    icon: IconUsers,
    title: 'Unified Workflow',
    description: 'GitHub + Slack + Jira in one seamless experience. No more context switching.',
  },
];

const integrations = [
  { icon: IconBrandGithub, name: 'GitHub', description: 'One-click installation' },
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-landing-text-muted max-w-2xl mx-auto">
            Built by developers, for developers. We understand the pain of manual PR assignment 
            because we've lived it. GitRouter is the solution we wish we had.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {values.map((value, i) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="text-xl font-semibold text-landing-text mb-2">{value.title}</h3>
            ...
            {integrations.map((integration, i) => (
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-medium text-landing-text">{integration.name}</div>
                  <div className="text-xs text-landing-text-muted">{integration.description}</div>
                </div>
              </div>
            ))}
          </div>
