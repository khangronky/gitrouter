...
export function RoutingCell() {
  ...
  const handleMouseEnter = () => {
    ...
    timeoutRefs.current.push(setTimeout(() => setPhase(2), 500));

    // Phase 3: Complete - show checkmarks
    timeoutRefs.current.push(setTimeout(() => setPhase(3), 1000));
  };
        ...
        <div className="flex-1 flex items-center min-w-[40px]">
          ...
          <IconChevronRight
            className={cn(
              ...
              leftLineActive
                ? 'text-landing-accent opacity-100'
                : 'text-landing-text-muted opacity-50'
            )}
          />
        </div>
        ...
        <div className="flex flex-col items-center gap-2 shrink-0">
          <div
            className={cn(
              ...
              leftLineActive
                ? 'border-landing-accent/50 shadow-md shadow-landing-accent/10'
                : 'border-landing-border'
            )}
          >
            <div className="text-[10px] font-semibold text-landing-text/80 mb-1 text-center">
              Rules
            </div>
            <div className="flex gap-1">
              <span
                className={cn(
                  ...
                  leftLineActive
                    ? 'bg-blue-500/40 text-blue-700 dark:text-blue-300'
