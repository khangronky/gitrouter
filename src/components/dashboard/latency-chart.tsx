...
export function LatencyChart({
  ...
  return (
    <Card className={cn("h-full p-4 flex flex-col justify-between ", className)}  >
      ...
      <ChartContainer config={chartConfig} className="h-[225px] w-full">
        <AreaChart data={latencySeries} margin={{ top: 10, right: 10, bottom: 0, left: -20 }}>
          <defs>
          ...
          <ReferenceLine
            ...
            strokeDasharray="5 5"
            strokeWidth={1.5}
            label={{ value: 'Target', position: 'right', fill: 'var(--destructive)', fontSize: 11 }}
          />
          <ChartTooltip
