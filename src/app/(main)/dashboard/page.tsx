        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="text-muted-foreground">
              <th className="px-3 py-3 text-left font-medium border-b border-border">
                Repo
              </th>
              <th className="px-3 py-3 text-center font-medium border-b border-border">
                Avg Review Time
              </th>
              <th className="px-3 py-3 text-center font-medium border-b border-border">
                PRs Pending
...
function StalePRs() {
  return (
    <Card className="relative p-4 overflow-hidden">
      ...
      <button className="absolute left-4 bottom-4 inline-flex items-center px-3 py-1.5 text-xs font-medium text-white bg-primary-700 hover:bg-primary-600 transition-colors">
        View All Stale PRs
      </button>
    </Card>
  );
