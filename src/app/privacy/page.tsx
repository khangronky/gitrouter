export default function PrivacyPolicyPage() {
    return (
      <div className="container mx-auto max-w-3xl py-12 px-4">
        ...
        <p className="text-muted-foreground mb-4">Last updated: December 2, 2025</p>
        ...
        <section className="space-y-4">
          ...
          <p>We store OAuth tokens securely to maintain your connection. We do not store your Jira issues or project data.</p>
